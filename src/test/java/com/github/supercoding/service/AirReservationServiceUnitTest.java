...
class AirReservationServiceUnitTest {
    ...
    void findUserFavoritePlaceTicketsCase1() {
        ...
        when(airlineTicketJpaRepository.findAllAirlineTicketsWithPlaceAndTicketType(likePlace, ticketType))
    ...
    @DisplayName("TicketType이 왕복 | 편도가 아닌경우 Exception을 발생")
    @Test
    ...
    @DisplayName("User를 찾을 수 없는 경우 Exception을 발생")
    @Test
